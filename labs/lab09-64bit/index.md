...
<li>In-lab: none -- the report (the only part of the in-lab) is not to be done.  Instead, use this time to get help with the pre-lab or the in-lab.  Because of this, the in-lab will not be graded this semester.</li>
<li>in-lab: the C tutorial is still to be done, but the report is not to be done.</li>
</ul>
