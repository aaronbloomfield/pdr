...
- 64 bit materials: [64 bit assembly slides](08-assembly-64bit.html#/)
    ...
    - The tutorial for [lab 8](../labs/lab08/index.html) ([md](../labs/lab08/index.md))
       - Tutorial 8 is nasm, which consists of two PDF book chapters that are contained in this repository: [x86 Assembly](../book/x86-64bit-asm-chapter.pdf) and [The x86 C Calling Convention](../book/x86-64bit-ccc-chapter.pdf); the contain more examples of assembly code
  ...
  - You can view the [32 bit assembly material](32bit.html) ([md](32bit.md)), which was used in past years.
