...
[Slide set 1: Course Introduction](../cs2150/course-introduction.html) **(CS 2150 specific)**
...
[Slide set 3: Lists](02-lists.html)
...
[Slide set 4: Numbers](03-numbers.html)
...
[Slide set 9: x86 (assembly language)](08-x86.html)
...
[Slide set 10: Advanced C++](09-advanced-cpp.html)

- Source code: [name-contact.cpp](code/09-advanced-cpp/name-contact.cpp.html) ([src](code/09-advanced-cpp/name-contact.cpp))

[Slide set 11: Heaps and Huffman coding](10-heaps-huffman.html)

- Source code: [priority_queue.cpp](code/10-heaps-huffman/priority_queue.cpp.html) ([src](code/10-heaps-huffman/priority_queue.cpp)), [priority_queue.h](code/10-heaps-huffman/priority_queue.h.html) ([src](code/10-heaps-huffman/priority_queue.h)), [pq-test.cpp](code/10-heaps-huffman/pq-test.cpp.html) ([src](code/10-heaps-huffman/pq-test.cpp)),

[Slide set 12: Graphs](11-graphs.html)

[Slide set 13: Memory](12-memory.html)
...
[Slide set 14: Esoteric Programming Languages](13-esoteric-pls.html)

[Slide set 15: Course Conclusion](../cs2150/course-conclusion.html) **(CS 2150 specific)**
